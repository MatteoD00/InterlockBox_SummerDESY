...
import time
import serial
import equipment.connection_message_based as com

from equipment.constants import Interface
from equipment.exceptions import AimTTiError
...
class MXSeries():
    ...
    def connect(self):
        self.mtti=serial.Serial('COM4',9800)
        self.com=com()
        return self.mtti
    ...
    def _query_and_check(self, command):
        ...
        """
        try:
            return self.com.query(command).rstrip()
        except:
