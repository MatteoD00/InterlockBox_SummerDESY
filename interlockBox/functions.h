...
void scanNetworks();
void printWiFiData();
void sendDataDB(float* Temp, float* RH, float* DewPoint, const int nHYT, const int nNTC, float flow, bool hv_intlk, bool hv_signal,bool solenoidstatus,bool doorstatus);
